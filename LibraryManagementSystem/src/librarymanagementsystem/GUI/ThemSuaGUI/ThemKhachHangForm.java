...
public class ThemKhachHangForm extends JFrame {
    ...
    private void initComponents() {
        ...
        this.addButton.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ThemKhachHangForm.this.addButtonMouseClicked(evt);
            }
        });
        ...
        this.exitButton.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ThemKhachHangForm.this.exitButtonMouseClicked(evt);
            }
        });
        ...
        this.movingWindow.addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseDragged(MouseEvent evt) {
                ThemKhachHangForm.this.movingWindowMouseDragged(evt);
            }
        });
        this.movingWindow.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {
                ThemKhachHangForm.this.movingWindowMousePressed(evt);
            }
        });
        ...
        this.ngaySinh_textField.setText("");
        ...
        this.nhanVienForm.setIcon(new ImageIcon(this.getClass().getResource("../../images/output-onlinepngtoolsthemkh.png")));
    ...
    private void addButtonMouseClicked(MouseEvent evt) {
        ...
        String maKH = this.dp.next_maKhachHang((new QLKhachHangBUS(0)).getPKey());
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(ThemKhachHangForm.class.getName()).log(Level.SEVERE, (String)null, var5);
        } catch (InstantiationException var6) {
            Logger.getLogger(ThemKhachHangForm.class.getName()).log(Level.SEVERE, (String)null, var6);
        } catch (IllegalAccessException var7) {
            Logger.getLogger(ThemKhachHangForm.class.getName()).log(Level.SEVERE, (String)null, var7);
        } catch (UnsupportedLookAndFeelException var8) {
            UnsupportedLookAndFeelException ex = var8;
            Logger.getLogger(ThemKhachHangForm.class.getName()).log(Level.SEVERE, (String)null, ex);
        }
