package librarymanagementsystem.GUI.ElementsGUI.ChoiceGUI;
...
public class ChoiceElement extends javax.swing.JFrame {
    ...
    private void initComponents(String image, String text) {
        ...
        form.setIcon(new javax.swing.ImageIcon(getClass().getResource("../../../images/layout.png"))); // NOI18N
    ...
    private void jPanel1MouseEntered(java.awt.event.MouseEvent evt) {                                     
        form.setIcon(new javax.swing.ImageIcon(getClass().getResource("../../../images/layout1.png"))); // NOI18N
    }                                    
